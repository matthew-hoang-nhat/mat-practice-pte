...
import 'package:mat_practice_pte/src/features/lesson/highlight_summary/cubit/highlight_summary_state.dart';
...
class HighlightSummaryCubit extends Cubit<HighlightSummaryState>
    implements LessonTypeCubit {
  HighlightSummaryCubit() : super(HighlightSummaryState.init());
